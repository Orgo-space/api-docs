...
<img src="/images/platform/workflows/workflow-trigger-config.png" alt="Trigger configuration panel with the grouped event type dropdown and the user type filter checkboxes" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
<img src="/images/platform/workflows/workflow-action-config.png" alt="Send Email action configuration with subject line, rich text editor and the delay section expanded showing days, hours and minutes" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
<img src="/images/platform/workflows/workflow-execution-logs.png" alt="Workflow execution log table with trigger, user, status and duration columns and the status filter open" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
