...
**Send Email** needs a **Subject Line** and **Email Content** in the rich editor; the builder refuses to save without both, as tag actions refuse to save without a tag. These placeholders belong in the email body, where they are replaced per recipient at send time. The subject line is sent exactly as you typed it, so a placeholder there arrives unreplaced.
