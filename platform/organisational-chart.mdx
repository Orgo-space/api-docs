...
<img src="/images/platform/features/org-chart.png" alt="Organisational chart showing leadership hierarchy" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
