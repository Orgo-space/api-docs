...
<img src="/images/platform/communication/discussions-list.png" alt="Group forum with the category panel listing All plus each of the group's categories, and the post list filtered to the selected category" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
