...
Discussions are the conversation layer inside every group. Members create posts, others reply, react, and share files — like a forum built into each group. The Main Group has org-wide discussions, Local Centers have local conversations, and Private Groups have team-specific threads.
