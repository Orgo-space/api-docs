...
A member who simply does not want to read another member does not need a moderator at all. See [Blocking Members](/platform/discussion/blocking-members), which hides one member's content for one other member and leaves it up for everybody else.
