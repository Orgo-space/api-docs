...
| **Financial Parent Local** | Local Parent | - | VIEW Confidential, UPDATE Docs | Full Payment/Products | - | - | Financial Local, HR Assistant Local/Parent |
| **Financial Local** | Local | - | VIEW Confidential, UPDATE Docs | Full Payment/Products | - | - | HR Assistant Local |
| **Communication Parent Local** | Local Parent | - | - | - | - | Full Newsletter/Moderation | Communication Local |
| **Communication Local** | Local | - | - | - | - | Full Newsletter/Moderation | - |
| **Event Parent Local** | Local Parent | - | - | - | CREATE/UPDATE | - | Event Local |
