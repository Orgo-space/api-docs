...
Permissions control what users can do in the platform. Unlike [organizational roles](/platform/users/roles), permissions directly grant access to features and data.

<Info>
  Looking for how to create positions like "President" or "Secretary"? See [Roles](/platform/users/roles) for organizational structure.
</Info>
...
- [Roles](/platform/users/roles) - Organizational positions and role management
