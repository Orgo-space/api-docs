...
<Steps>
  ...
  <Step title="Tick every phrase you want to override">
    ...
    <img src="/images/platform/customization/text-replacement-search.png" alt="Add Text Replacement panel searching for local center, listing the matching interface phrases as checkboxes, with the capitalised and the lowercase form of the same phrase both ticked so the footer button reads Add (2)" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
  </Step>
