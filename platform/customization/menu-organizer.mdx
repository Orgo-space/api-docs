...
"og:description": 'Rearrange, hide, and rename sidebar navigation items — with permission-based visibility and custom categories'
"twitter:title": 'Menu Organizer | Orgo'
"twitter:description": 'Rearrange, hide, and rename sidebar navigation items — with permission-based visibility and custom categories'
---
