...
<img src="/images/platform/communication/newsletter-builder.png" alt="Email builder with the design canvas in the middle, the content block palette on the right, and the placeholder list on the left" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
<img src="/images/platform/communication/newsletter-create.png" alt="New campaign form with campaign details, the recipient options, and the template picker below them" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
