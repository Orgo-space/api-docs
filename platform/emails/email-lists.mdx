...
manual list sends to exactly the rows in it.
...
<AccordionGroup>
  <Accordion title="The campaign reached fewer people than the list holds">
    The difference is the unsubscribed. Open the list and compare **Total** with
    **Subscribed**, then use the subscription chips on the recipients table to see
    exactly who was skipped.
  </Accordion>
