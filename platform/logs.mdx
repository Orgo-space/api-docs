...
<img src="/images/platform/logs/activity-log-detail.png" alt="The expanded details panel of an activity log row, showing the JSON diff with the old and new value for each changed field" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
