...
| Regional director | `ADMIN_PARENT_LOCAL` | Their anchor chapter and every chapter beneath it, at any depth |
| Regional membership officer | `HR_PARENT_LOCAL` | Members across that same branch |
