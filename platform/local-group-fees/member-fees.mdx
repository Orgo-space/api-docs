...
<img src="/images/platform/fees/chapter-member-fees.png" alt="Member fees table for a chapter with member, unit and fee tier columns and one column per fee period" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
