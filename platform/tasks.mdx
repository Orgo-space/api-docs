...
<img src="/images/platform/projects/task-form-modal.png" alt="New task modal with a title, rich description, checklist and a side panel holding goal, type, assignees, priority, status and dates" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
<img src="/images/platform/projects/task-detail.png" alt="Task detail page showing status and type controls, assignees with completion ticks, a checklist and a comment thread" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
<img src="/images/platform/projects/project-board.png" alt="Kanban board with To do, In Progress and Done columns holding task cards with avatars, priority icons and due dates" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
