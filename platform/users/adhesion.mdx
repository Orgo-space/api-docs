...
"og:description": 'Require a formal application and approval process before granting membership'
"twitter:title": 'Adhesion (Membership Applications) | Orgo'
"twitter:description": 'Require a formal application and approval process before granting membership'
---

Orgo Adhesion is a membership application and approval module within Orgo that lets organizations require a form, document uploads, and admin review before granting membership access.

**Built for:** organizations that screen or approve new members before granting access, such as professional associations, trade unions, faith communities, and cooperatives, and any organization that needs a documented approval trail for new members.

**Replaces:** Google Forms plus manual email review for collecting and tracking membership applications, not for general surveys unrelated to membership admission.

Instead of "register and you're in," members must submit an application that administrators review and approve, return for revision, or reject.
