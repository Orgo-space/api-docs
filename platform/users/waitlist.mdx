...
The entry is in the menu whether or not the waitlist is on, and every setting below lives on that page, starting with the switch that enables it.
...
The bulk actions apply that same scope entry by entry, not once at the door: an
