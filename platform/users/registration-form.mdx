...
To set this up:
1. Create your user types in **Settings** → **Roles & User Types**
...
<AccordionGroup>
  ...
  <Accordion title="I need to collect a field that doesn't exist in the standard list">
    Create a [Custom Field](/platform/users/custom-fields) (Settings → Custom Fields), then come back to the registration form builder — your custom field will appear at the bottom of the field list.
  </Accordion>
</AccordionGroup>
