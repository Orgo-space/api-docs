...
"og:description": 'Check in attendees with QR codes, track who showed up, and manage no-shows'
"twitter:title": 'Event Attendance | Orgo'
"twitter:description": 'Check in attendees with QR codes, track who showed up, and manage no-shows'
---
