...
"og:title": 'Event Types | Orgo'
"og:description": 'Categorize events for filtering, reporting, and clear communication'
"twitter:title": 'Event Types | Orgo'
"twitter:description": 'Categorize events for filtering, reporting, and clear communication'
---
