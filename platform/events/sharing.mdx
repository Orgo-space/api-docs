...
**Agenda**, and use **Iframe URL**. The button only appears when the event is public or ticketed.
...
| Copy the agenda embed address | Access to the event's Agenda screen: owner, `EVENT_LOCAL` or `EVENT_TENANT` |
