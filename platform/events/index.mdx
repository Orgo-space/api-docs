...
Orgo Events is the event management module within Orgo that lets organizations create and publish events, sell tickets or take free RSVPs, and track attendance from within their member database.

**Built for** membership organizations running events for members and the public, including professional associations, youth organizations, alumni networks, and faith communities, and similar member-based groups.

**Replaces** Eventbrite for ticketing and RSVP management tied to your member database, not for public event marketplace discovery.

Events are often the core of what your organization does — meetups, trainings, conferences, assemblies, volunteer activities. Orgo checks people in at the door and generates reports that prove your impact.
