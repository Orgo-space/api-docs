...
<img src="/images/platform/events/event-app-my-events.png" alt="My events screen on a phone listing event cards grouped under an organisation logo, with a Signed in as line and a My profile button" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
| Tab | Appears when |
|---|---|
| **Program** | The event has at least one sub-event (session). Called the agenda everywhere else in the product; the tab itself is labelled Program |
...
See [Event App: agenda, feed and votes](/platform/events/event-app-feed) and [Event App: networking](/platform/events/event-app-networking) for what each one does.
...
- [Event App: agenda, feed and votes](/platform/events/event-app-feed) - The in-event surfaces
