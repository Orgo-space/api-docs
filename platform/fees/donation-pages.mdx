...
<img src="/images/platform/fees/donation-comments.png" alt="Donor message moderation list showing every message on the campaign, each row with the date, donor, amount, message, an approved status, and a Delete button in the Actions column" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
| **Donation Settings** | Default currency (13 options), widget language (Romanian, English, German, French, Spanish, Italian), default donation type (one-time or monthly), and, for popup widgets only, show monthly upsell and require address details; preset amounts for one-time and for monthly, initial suggested amount |
