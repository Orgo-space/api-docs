...
<img src="/images/platform/fees/donation-comments.png" alt="Donor message moderation list with filters for name, message text and status, and rows showing donor, amount, message and a delete action" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
<img src="/images/platform/fees/donation-public-page-donors.png" alt="Public donation page sidebar showing the recent donations panel with donor initials, amounts and relative dates, plus See all and See top buttons" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
...
<img src="/images/platform/fees/donation-widgets-tab.png" alt="Widgets tab showing two donation widget cards, one embed and one popup, each with its widget ID and total, one-time and recurring donation counts" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
