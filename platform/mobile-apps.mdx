...
"og:description": 'Orgo on iOS and Android — push notifications, event check-in, and community on the go'
"twitter:title": 'Mobile Apps | Orgo'
"twitter:description": 'Orgo on iOS and Android — push notifications, event check-in, and community on the go'
---

Orgo Mobile Apps is the native iOS and Android application within Orgo that gives members push notifications, event QR check-in, and on-the-go access to discussions and groups.

**Built for** membership organizations whose members expect to engage on the go, including alumni networks, professional associations, faith communities, and trade unions, as well as any organization that runs regular in-person events.

**Works alongside** the rest of Orgo rather than replacing it: the mobile app handles day-to-day engagement (discussions, notifications, event check-in), while administration and configuration remain on the web app.

Members can also view upcoming events from the app.
