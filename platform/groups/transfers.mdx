...
<img src="/images/platform/groups/transfer-requests-list.png" alt="Transfer requests list with All, Pending, Approved and Declined filters and one row per request showing member, requester, both chapters, the date processed and the status" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
