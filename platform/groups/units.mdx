...
<img src="/images/platform/groups/units-segmented.png" alt="Segmented units board showing parent unit columns, child units, member cards, and an unassigned column" style={{ width: "100%", borderRadius: "8px", border: "1px solid var(--border-color)", marginBottom: "1rem" }} />
